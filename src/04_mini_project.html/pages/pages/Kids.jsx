...
function Kids() {
  const redirect = useNavigate();
   ...
   const fetchData = async () => {
      const { data } = await axios.get(`http://localhost:3000/product/?prod_cat=${"Kids eyewear"}`);
      setdata(data);
   };

   return (
      <div>
         {/* ***** Main Banner Area Start ***** */}const redirect = useNavigate();


         <div className="page-heading ph-kid" id="top" >
